        ...
        <div class="sidebar">
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    ...
                    <li class="{{ isset($pageSlug) && $pageSlug == 'upgrade' ? 'active' : '' }} bg-info">
        ...
        <div class="main-panel">
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <ul class="nav">
                        <li class="nav-item">
                            <a href="https://creative-tim.com" target="blank" class="nav-link">Creative Tim</a>
                        </li>
                        <li class="nav-item">
                            <a href="https://updivision.com" target="blank" class="nav-link">Updivision</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="dropdown show-dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li class="button-container">
                    ...
                    <a href="https://black-dashboard-laravel.creative-tim.com/docs/getting-started/laravel-setup.html" target="_blank" class="btn btn-default btn-block btn-round">Documentation</a>
